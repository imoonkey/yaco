...
**Verification:** `scripts/verify.sh` green; CLI unit suite 1 419 tests. Two cross-provider review rounds (`plan/all/history-subtree-scope/review_codex.md`). End-to-end QA of both affected flows against the operator's real provider homes, with the before/after contrast measured against the installed build: `plan/all/history-subtree-scope/qa.md`.
**Commit:** `686b7de9..HEAD`
**Blockers:** None.

...
- **Row order is ascending by `name`** and is part of the contract, not an accident of the directory read. -> See: [architecture.md#read-ordering](architecture.md#read-ordering).

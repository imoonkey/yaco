...
└── Workspace (re-export → workspace/WorkspaceScreen)
    └── WorkspaceScreen (~651 lines) — controller
        ...
        ├── ProjectList (~146 lines) — project rows only (worktree selection moved to the header-toggled Files-panel WorktreePicker, §P2…§P2e)

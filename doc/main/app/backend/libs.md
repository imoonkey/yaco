...
- The spawn is deliberate and measured, not a leftover. Pulling the read in process was benchmarked under concurrent requests and rejected: it starves a concurrent request to p95 204 ms against the subprocess route's 2.3 ms, and even a bounded, chunked prototype stays 3–4× over the bound. -> See: [../../cli/exports.md](../../cli/exports.md#the-one-query-rule-5-has-judged).

...
Run `/update-doc` (**MUST USE**) to sync the project's doc folder (`yaco paths project --json` → `doc`), project-local skills in `./.claude/skills/*`, and `<doc>/PROGRESS.md` if the project keeps one.

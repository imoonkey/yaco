...
`/office-hours [problem, idea, or area you want to explore]`
...
- Ask the 2 most critical remaining questions from the smart routing table, then proceed to Phase 3.
...
Present the design doc path to the user. Summarize what was decided.

**Startup mode:** End with The Assignment — one concrete action.

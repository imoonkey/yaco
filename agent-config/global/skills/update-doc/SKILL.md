...
One axiom; the rest are corollaries — hold every architecture doc to the axiom and the others follow.
...
Most architecture docs follow this shape — adapt it, don't force it:

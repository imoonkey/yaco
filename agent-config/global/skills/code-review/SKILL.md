...
- **After documenting findings** (Step 3): append a `human_review` entry to `progress.json` summarizing findings (e.g., "Code review complete — 1 critical, 2 high, 1 medium finding."). Set workstream status to `human_review`.

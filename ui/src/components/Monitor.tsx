import { useSessions, useProgress, dismissProgress as apiDismiss } from '../hooks/useApi'
import type { ProgressEntry, ProgressType, AgentSession, SessionStatus } from '../types'
...
export function Monitor({ filterProject }: { filterProject: string | null }) {
  ...
  const { data: progress, refresh } = useProgress()

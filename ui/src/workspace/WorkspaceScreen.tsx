...
export function Workspace({
  ...
  const terminalContent = attachedSession ? (
    <>
      <div className="h-9 flex items-center gap-2 px-2 text-[12px] shrink-0" style={{ backgroundColor: 'var(--sol-header-bg)', borderBottom: '1px solid var(--sol-border)', color: 'var(--sol-text-brown)', fontFamily: 'var(--font-ui)' }}>

...
export function SectionHeader({ title, collapsed, onToggle, actions, badge }: {
  ...
  return (
    <div className="flex items-center h-[28px] px-2 text-[11px] font-semibold uppercase tracking-wider cursor-pointer select-none shrink-0"
      style={{ backgroundColor: 'var(--sol-header-bg)', color: 'var(--sol-text-brown)', fontFamily: 'var(--font-ui)', borderBottom: '1px solid color-mix(in srgb, var(--sol-border) 50%, transparent)' }} onClick={onToggle}>
